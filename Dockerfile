...
wget https://raw.githubusercontent.com/slowpeek/ubuntu-remaster-f2fs/master/ubuntu-remaster-f2fs
chmod +x unmkinitramfs-turbo ubuntu-remaster-f2fs
EOF

ENTRYPOINT ["ubuntu-remaster-f2fs"]
